...
image_id = get_start_image_id(train_path)

print(f'Preparing Train Data (resume from image_id={image_id})')
...
image_id = get_start_image_id(test_path)
print(f"Resuming TEST from image_id = {image_id}")
