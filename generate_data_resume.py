...
import random
import os
def get_last_saved_index(train_path):
    raw_dir = os.path.join(train_path, "raw")
...
image_id = get_last_saved_index(train_path)
print("Resume Train Data from ID =", image_id)
...
image_id = get_last_saved_index(test_path)
print("Resume Test Data from ID =", image_id)
